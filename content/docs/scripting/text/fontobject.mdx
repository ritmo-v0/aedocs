...
<Callout type="idea">Will return undefined for non-variable fonts.</Callout>
...
FontObjects can be looked up by fontID with [getFontByID](fontsobject.mdx#fontsobjectgetfontbyid) .
...
<Callout type="idea">Can only return `true` when called on a variable [Font object](#font-object) with the argument also being a [Font object](#font-object) of a variable font.</Callout>
