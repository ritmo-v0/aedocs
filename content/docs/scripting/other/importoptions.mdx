...
The constructor takes an optional parameter, an [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object for the file.
...
[ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object; read/write.
...
| Parameter | Type                                                                                              | Description       |
| --------- | ------------------------------------------------------------------------------------------------- | ----------------- |
| `file`    | [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object | The file to check |
