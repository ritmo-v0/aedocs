...
The [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object for the footage's source file.
...
| --------- | ------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| `file`    | [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object | The file to be used as the footage main source. |
...
| Parameter           | Type                                                                                              | Description                                                           |
| ------------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `file`              | [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object | The first file in the sequence to be used as the footage main source. |
