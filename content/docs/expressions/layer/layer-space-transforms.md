...
Transform two different "Bulge Center" properties from the _layer space_ of the layer the effect is applied to, to the _world space_ of the comp the layers live in:
...
Convert layer #2's position from world space to _this layer's_ space:
