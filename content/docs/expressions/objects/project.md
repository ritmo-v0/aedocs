...
This category holds info related to your current _project_ as a whole -- that is, the current AEP. Thus, changing the corresponding project settings will also update the values that these expressions return.
...
The color depth of the project in bits per channel (bpc), as set in _Project Settings > Color Management_
...
The state of the Blend Colors Using 1.0 Gamma option in _Project Settings > Color Management_.
