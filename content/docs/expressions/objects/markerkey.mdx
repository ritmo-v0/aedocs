...
Dan Ebberts provides a tutorial on the [After Effects Developer Center](https://www.adobe.com/devnet/aftereffects/) that includes an example of using XMP metadata with expressions.
