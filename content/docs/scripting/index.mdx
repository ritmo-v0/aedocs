...
If you're not sure where to start, take a look at the [Overview](./introduction/overview.mdx) for how scripting works in After Effects, or [Changelog](./introduction/changelog.mdx) for updates to the scripting API over time.
