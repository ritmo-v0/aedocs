...
<Callout>MaskPropertyGroup is a subclass of [PropertyGroup object](propertygroup.mdx). All methods and attributes of [PropertyBase object](propertybase.mdx) and PropertyGroup, in addition to those listed below, are available when working with MaskPropertyGroup.</Callout>
