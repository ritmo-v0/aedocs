...
Because pathname syntax is very different in different operating systems, Adobe ExtendScript defines [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) and [ExtendScript Folder](https://extendscript.docsforadobe.dev/file-system-access/folder-object/) objects to provide platform-independent access to the underlying file system.
...
ExtendScript provides a common scripting environment for all Adobe applications, and allows inter-application communication through scripts.
