...
{/* ! If the folder name changes from "scripting", update the links below accordingly */}

If you're not sure where to start, take a look at the [Overview](./scripting/introduction/overview) for how scripting works in After Effects, or [Changelog](./scripting/introduction/changelog) for updates to the scripting API over time.
