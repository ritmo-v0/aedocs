...
They are one of 8, 16, or 32. Equivalent to the scripting project attribute [`app.project.bitsPerChannel`](../../scripting/general/project/#projectbitsperchannel).
...
Equivalent to the scripting project attribute [`app.project.linearBlending`](../../scripting/general/project/#projectlinearblending).
