...
This category describes items that give you _other objects_ based on the current layer; things like the source (for precomps or footage), effects, masks, sourceRect, etc.
