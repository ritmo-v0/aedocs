...
- Added: Expression access to variable font axes through text animators
  - Added: [Variable Font Axes](../text/variable-fonts) - Access variable font axes (Weight, Width, Slant, etc.) via `text.animator("Animator Name").property.fontAxis[Tag]`
- Added: Property methods for finding neighboring keyframes and markers
  - Added: [Property.previousKey()](../objects/property#previouskey)
  - Added: [Property.nextKey()](../objects/property#nextkey)
- Added: Expression access to dropdown menu text strings
  - Added: [Dropdown Menus](../objects/dropdown-menu)
    - Added: [Dropdown Menu.items](../objects/dropdown-menu#items)
    - Added: [Dropdown Menu.text](../objects/dropdown-menu#text)
    - Added: [Dropdown Menu.textAtTime()](../objects/dropdown-menu#textattime)
...
- Fixed: The property, this\_Layer had stopped working when using the Legacy ExtendScript expression engine.
...
- Fixed: Applying the [createPath()](../objects/path-property#pathpropertycreatepath) expression via the Expression Language menu autofills the (is\_Closed) parameter as deprecated snake case instead of camel caseisClosed.
