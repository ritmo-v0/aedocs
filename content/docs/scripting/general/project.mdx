...
The [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object for the file containing the project that is currently open.

#### Type

[File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object or `null` if project has not been saved; read-only.
...
The [Render Queue](../render-queue/renderqueue) of the project.

#### Type

[RenderQueue object](../render-queue/renderqueue); read-only.
...
| Parameter      | Type                | Description                                                                                                                                                                                                                                                                     |
| -------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `closeOptions` | `CloseOptions` enum | Action to be performed on close. One of:<br /><br />- `CloseOptions.DO_NOT_SAVE_CHANGES`: Close without saving.<br />- `CloseOptions.PROMPT_TO_SAVE_CHANGES`: Prompt for whether to save changes before close.<br />- `CloseOptions.SAVE_CHANGES`: Save automatically on close. |
...
Pass a [File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object to save a project to a new file without prompting.

#### Parameters

| Parameter | Type                                                                                       | Description                 |
| --------- | ------------------------------------------------------------------------------------------ | --------------------------- |
| `file`    | [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) | Optional. The file to save. |
...
- `var myFolder = new Folder("C:/My Folder");`<br />`app.project.setDefaultImportFolder(myFolder);`
...
| Parameter      | Type                                                                                       | Description                                                                                             |
| -------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| `project_file` | [ExtendScript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) | The local After Effects project. File extension should be either .aep or .aet (.aepx is not supported). |
...
| Parameter     | Type               | Description                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ResolveType` | `ResolveType` enum | The type of conflict resolution to use. One of:<br /><br />- `ResolveType.ACCEPT_THEIRS`: Take the shared version. The shared version replaces your version.<br />- `ResolveType.ACCEPT_YOURS`: Keep your version of the project. The shared version is not taken.<br />- `ResolveType.ACCEPT_THEIRS_AND_COPY`: Copy and rename your version, then take the shared version. The shared version replaces your original version. |
