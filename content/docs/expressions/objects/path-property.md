...
This category contains information relating to mask & shape _paths_.
...
+---------------+-----------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `inTangents` | Array of number pair arrays | Optional. An array of number pair arrays representing their `[x, y]` _offset_ coordinates. The length of this array must be exactly the same as the `points` parameter. Defaults to `[]`. |
| | | |
