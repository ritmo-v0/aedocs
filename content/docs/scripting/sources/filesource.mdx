...
The [Extendscript File](https://extendscript.docsforadobe.dev/file-system-access/file-object/) object for the file that defines this asset. To change the value:
