...
An [ItemCollection object](../item/itemcollection.mdx) containing Item object that represents the top-level contents of this folder.

Unlike the ItemCollection in the [Project object](../general/project.mdx), this collection contains only the top-level items in the folder. The top-level within the folder is not the same as top-level within the project.
