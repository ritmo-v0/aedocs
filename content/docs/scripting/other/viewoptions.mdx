...
The ViewOptions object represents the options for a given [View object](view.mdx)
...
<Callout type="warn">If you try to get or set the attribute's value in the Layer or Footage panel, you'll get an error message.</Callout>

<Callout type="idea">The Draft preview mode is only available in ray-traced 3D compositions. If you try to use it in a Classic 3D composition, you'll get an error: "Cannot set Draft fast preview mode in a Classic 3D composition."</Callout>
