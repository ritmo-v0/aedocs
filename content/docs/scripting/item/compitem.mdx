...
<Callout>CompItem is a subclass of [AVItem object](avitem.mdx), which is a subclass of [Item object](item.mdx). All methods and attributes of AVItem and Item, in addition to those listed below, are available when working with CompItem.</Callout>
...
<Callout>This functionality was added in After Effects 13.2 (CC2014).</Callout>
...
<Callout>This functionality was added in After Effects 17.1.</Callout>
...
<Callout>As of After Effects 17.1, the minimum value is `-10800.0`. Before 17.1, the minimum value was `0.0`</Callout>
...
A [LayerCollection object](../layer/layercollection.mdx) that contains all the Layer objects for layers in this composition.
...
A [PropertyGroup object](../property/propertygroup.mdx) that contains all a composition's markers. Composition marker scripting has the same functionality as [Layer markers](../layer/layer.mdx#layermarker).
...
Array of [Layer](../layer/layer.mdx) objects; read-only.
...
Array of [Property](../property/property.mdx) and [PropertyGroup](../property/propertygroup.mdx) objects; read-only.
...
<Callout type="idea">To rename a property as it is added to the EGP, see [Property.addToMotionGraphicsTemplateAs()](../property/property.mdx#propertyaddtomotiongraphicstemplateas).</Callout>
...
| Parameter    | Type                                                                                                                                          | Description                                                                                                                                                     |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `otherLayer` | [Layer object](../layer/layer.mdx) in this composition.                                                                                       | The `relIndex` value is added to the index value of this layer to find the position of the desired layer.                                                       |
...
[Viewer object](../other/viewer.mdx) object for the Composition panel, or `null` if the composition could not be opened.
