...
<Callout>
  Dan Ebberts provides more examples and techniques for creating trails of images on his [MotionScript](https://motionscript.com/mastering-expressions/follow-the-leader.html).
</Callout>
...
<Callout>
  Dan Ebberts explains this expression on his [site](https://www.adobe.com/go/learn_ae_motionscriptinvisiblelayer).
</Callout>
...
<Callout>
  Dan Ebberts explains this expression example in detail on his [website](https://motionscript.com/design-guide/auto-focus.html).
</Callout>
